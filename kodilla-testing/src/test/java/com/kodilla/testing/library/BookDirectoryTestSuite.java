...
public class BookDirectoryTestSuite {
    ...
    @Test  //4
    public void TestListBooksInHandsOfWhenTheUserHasNoBorrowedBooks() {
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        List<Book> resultListOf0Books = new ArrayList<Book>();
        LibraryUser libraryUser = new LibraryUser("Adam", "Myszka", "931015");
    ...
    @Test //5
    public void TestListBooksInHandsOfWhenTheUserHasBorrowedOneBook() {
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
    ...
    @Test //6
    public void TestListBooksInHandsOfWhenTheUserHasBorrowedFiveBooks() {
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
